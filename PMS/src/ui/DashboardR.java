...
public class DashboardR extends JFrame implements ActionListener {
    ...
    public DashboardR(User user) {
        ...
        scheduleApptBt.setFont(new java.awt.Font("sansserif", 1, 12)); 
        ...
        scheduleApptBt.addActionListener(this);
        ...
        cancelApptBt.setFont(new java.awt.Font("sansserif", 1, 12)); 
        ...
        cancelApptBt.addActionListener(this);

        rescheduleBt.setFont(new java.awt.Font("sansserif", 1, 12)); 
        ...
        rescheduleBt.addActionListener(this);
